...
contract MultiSigWallet is RelayRecipient {
    ...
    modifier transactionExists(uint transactionId) {
        require(transactions[transactionId].destination != address(0x0000000000000000000000000000000000000000), "Address equals 0x0");
        _;
    }
    ...
    modifier notNull(address _address) {
        require(_address != address(0x0000000000000000000000000000000000000000));
        _;
    }
    ...
    */
        ...
        validRequirement(_owners.length, _required)
    {
        for (uint i = 0; i<_owners.length; i++) {
            require(!isOwner[_owners[i]] && _owners[i] != address(0x0000000000000000000000000000000000000000), "Address is not an Owner" );
